...
const Menu = (props) => {
   ...
   const signout = () => {
    ...
    fetch(`${API_URL}/signout`)
      ...
      localStorage.removeItem('jwt_info')//(__Tues Cookie__)    

       props.history.push('/signin')//(__Me redireger vers Signin__)  
  ...
  return (
    <div>
            ...
            <Link style={isActive(props.history, '/')} className="navbar-brand" to="/">Ecommerce</Link>
