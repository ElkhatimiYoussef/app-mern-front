...
import "toastr/build/toastr.css";/*__toastr howa li ki afficher les message d'erreurs__*/
...
const submitSignin = e => {
      ...
      .then(res => {
          if(res.error) {
             ...
             props.history.push('/')/*__Redireger vers Home__*/
          }
 ...
 const form = () => (
  ...
  return (
    ...
    <Layout 
       title="Sign In" 
       description="Sign In In Node React Ecommerce App" 
       className="container"
    >
